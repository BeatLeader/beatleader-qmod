...
void BeatLeader::VotingButton::Init(QuestUI::ClickableImage* imageView) {
    ...
    this->hoverHint = QuestUI::BeatSaberUI::AddHoverHint(imageView->get_gameObject(), "Rank voring");

    SpinnerValuePropertyId = UnityEngine::Shader::PropertyToID(il2cpp_utils::createcsstr("_SpinnerValue"));
    GradientValuePropertyId = UnityEngine::Shader::PropertyToID(il2cpp_utils::createcsstr("_GradientValue"));
    StatePropertyId = UnityEngine::Shader::PropertyToID(il2cpp_utils::createcsstr("_State"));
    TintPropertyId = UnityEngine::Shader::PropertyToID(il2cpp_utils::createcsstr("_Tint"));
}
...
void BeatLeader::VotingButton::SetState(int state) {
    ...
    case 0:
        ...
        hoverHint->set_text(il2cpp_utils::createcsstr("Loading vote status"));
        break;
    case 1:
        UpdateMaterial(materialInstance, 0, 0, 0, UnityEngine::Color(0.2f, 0.2f, 0.2f, 0.0f));
        hoverHint->set_text(il2cpp_utils::createcsstr("Pass this map to vote it for ranked"));
        break;
    case 2:
        UpdateMaterial(materialInstance, 0, 1, 1, UnityEngine::Color(1.0f, 1.0f, 1.0f, 0.7f));
        hoverHint->set_text(il2cpp_utils::createcsstr("Vote for this map ranking status and stars"));
        break;
    case 3:
        UpdateMaterial(materialInstance, 0, 0, 2, UnityEngine::Color(0.2f, 0.8f, 0.2f, 0.4f));
        hoverHint->set_text(il2cpp_utils::createcsstr("Thank you for the vote!"));
        break;
