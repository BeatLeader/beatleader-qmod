...
void RecorderUtils::StartRecorderUtils() {
    // INSTALL_HOOK(BeatLeaderLogger, ActionButtonWasPressed);
    // INSTALL_HOOK(BeatLeaderLogger, PlayButtonPressed);
    // INSTALL_HOOK(BeatLeaderLogger, RestartButtonPressed);
    // INSTALL_HOOK(BeatLeaderLogger, RestartButtonPressed2);
    // INSTALL_HOOK(BeatLeaderLogger, LevelFailedCoroutine);
    // INSTALL_HOOK(BeatLeaderLogger, ScenesTransitionCoroutine);
}